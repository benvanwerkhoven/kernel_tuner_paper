...
def tune(do_strategy, do_method):
    ...
    result = kernel_tuner.tune_kernel("convolution_streams", [path+'convolution_streams.cu', path+'convolution.cu'],
        problem_size, args, tune_params,
        grid_div_y=grid_div_y, grid_div_x=grid_div_x, restrictions=restrict, verbose=True, lang="C",
        compiler_options=["-arch=sm_52", '-I'+path], strategy=do_strategy, method=do_method)
